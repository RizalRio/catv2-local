...
var getData = (function () {
  var table = function () {
    var datatable = $("#table_tests").KTDatatable({
      data: {
        type: "remote",
        source: {
          read: {
      ...
      columns: [
        ...
        { field: "description", title: "Deskripsi" },
        {
          ...
          template: function (row) {
            var status = {
              0: { title: "Tidak Aktif", state: "danger" },
