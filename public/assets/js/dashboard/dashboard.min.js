...
function fillTableTest(name, tes, date_open, date_expired) {
  var tableElement = `
    <tr>
      <td>${name}</td>
      <td>${tes}</td>
      <td><span class="font-weight-bolder text-success">${date_open}</span></td>
      <td><span class="font-weight-bolder text-danger">${date_expired}</span></td>
    </tr>
  `;
  return tableElement;
}
...
$(document).ready(function () {
  ...
  $.ajax({
    url: HOST_URL + "/getAllUserTestByStatus",
    type: "POST",
    data: {
      status: "Active",
    },
