...
var getData = function () {
    var table = function () {
        var datatable = $("#table_type").KTDatatable({
            data: {
                type: "remote",
                source: {
                    read: {
