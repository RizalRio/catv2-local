...
var getData = (function () {
  var table = function () {
    var datatable = $("#table_groups").KTDatatable({
      data: {
        type: "remote",
        source: {
          read: {
      ...
      columns: [
        ...
        { field: "users", title: "Pengguna" },
        {
          field: "manage",
          title: "Manage",
          template: function (row) {
            var status = {
              0: { title: "Not Manage", state: "danger" },
              1: { title: "Manage", state: "success" },
            };
            return (
              '<span class="label label-' +
              status[row.manage].state +
              ' label-dot mr-2"></span><span class="font-weight-bold text-' +
              status[row.manage].state +
              '">' +
              status[row.manage].title +
              "</span>"
            );
          },
        },
