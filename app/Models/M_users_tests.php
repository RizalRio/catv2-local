...
class M_users_tests extends Modelku
{
  ...
  protected $kolom       = 'a.id, a.id no, a.user_id, test_id, name, d.username, fullname, c.address, c.age, c.gender, c.education, c.experience, c.duration, c.purpose, c.concentration, description, level, question, open, close, time, start, end, answers, last_question, a.status, a.active';
  protected $gabung      = [
