...
class Narrations extends AdminController
{
    protected $module = 'narrations';

    public function __construct()
    {
        if (!in_groups(['IM', 'SA']) && !has_permission($this->module))
            throw \CodeIgniter\Exceptions\PageNotFoundException::forPageNotFound();
        $this->model = new \App\Models\M_Narrations();
    }
    ...
    public function index()
    {
        ...
        $this->data['pageTitle']  = 'Narrations';
        $this->data['title']      = 'Data Narrations';
        $this->data['subTitle']   = 'Metode tes yang digunakan';
        $this->data['breadCrumb'] = ['Dashboard' => 'support', 'Narrations' => ''];
    ...
    public function create()
    {
        ...
        $this->data['pageTitle']  = 'Narration';
        $this->data['title']      = 'Create Narration';
        $this->data['breadCrumb'] = ['Dashboard' => 'support', 'Narration' => $this->module, 'Create' => 'create'];
    ...
    {
        return $this->model->baris($id, ['select' => 'a.method_id, a.id, a.name, a.description, a.active']);
    }
    ...
    public function edit($id)
    {
        ...
        $this->data['pageTitle']  = 'Narrations';
        $this->data['title']      = 'Edit Narrations';
        $this->data['breadCrumb'] = ['Dashboard' => 'support', 'Narrations' => $this->module, 'Edit' => 'edit'];
