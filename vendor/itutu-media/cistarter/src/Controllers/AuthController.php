	...
	public function attemptRegister()
	{
		if ($this->request->isAJAX()) {
			...
			$rules = [
				...
				'username'  =>
				[
					'rules' 	=> 'required|alpha_numeric_space|min_length[6]|is_unique[users.username]',
					'errors' 	=>
					[
						'is_unique' => lang('Register.errorUsernameUnique')
					]
				],
				'email'     =>
				[
					...
					'errors'	=>
					[
						'is_unique' => lang('Register.errorEmailUnique')
					]
				],
				'password'  =>
				[
			...
			$user->avatar = 'assets/media/users/default.jpg';
