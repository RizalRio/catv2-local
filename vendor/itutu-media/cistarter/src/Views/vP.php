    ...
    <div class="d-flex flex-row flex-column-fluid page">
      <div class="d-flex flex-column flex-row-fluid" id="kt_wrapper">
        <div class="content p-0 d-flex flex-column flex-column-fluid" id="kt_content">
          <div class="d-flex flex-row-fluid bgi-size-cover bgi-position-top" style="background-image: url('<?= site_url("assets/media/bg/bg-5.jpg"); ?>')">
            <div class="container">
              <div class="d-flex justify-content-between align-items-center pt-25 pb-35">
                ...
                <div class="d-flex">
                  <a href="#" class="h5 text-light font-weight-bold pr-10" data-toggle="modal" data-target="#petunjukModal">Petunjuk Penggunaan</a>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>Selamat datang di aplikasi tes psikologi. Aplikasi ini dirancang untuk membantu Anda lebih memahami diri dan potensi Anda melalui tes psikologi yang akurat dan mudah digunakan.
            <br>
            Silakan mulai dengan membuka menu <b>Pesanan Saya</b> untuk memilih tes yang Anda butuhkan. Kami siap membantu Anda dalam setiap langkah prosesnya. Selamat menggunakan aplikasi ini, dan semoga bermanfaat.
          </p>
        </div>
      </div>
    </div>
